package impl.com.pixelduke.transit;
...
public class ToggleSwitchSkin extends SkinBase<ToggleSwitch> {
    ...
    private final InvalidationListener thumbDisplayChanged = observable -> this.updateThumbDisplay(getThumbDisplay());
    ...
    private final StyleableObjectProperty<ThumbDisplay> thumbDisplay = new SimpleStyleableObjectProperty<>(THUMB_DISPLAY_META_DATA, ThumbDisplay.LEFT) {
        @Override
    ...
    private static class InnerToggleSwitch extends Region {
        private final boolean isFirstLayoutPass = true;
        private final ToggleSwitchSkin toggleSwitchSkin;
        private final TranslateTransition transition;

        private final StackPane thumb = new StackPane();

        private final InvalidationListener selectionChanged = observable -> this.selectedStateChanged();
