...
public class ShrinkToggleButtonSkin extends ToggleButtonSkin {
    private final ButtonAnimationHelper buttonAnimationHelper;

    public ShrinkToggleButtonSkin(ToggleButton button) {
        super(button);
    ...
    private static final CssMetaData<ToggleButton, Boolean> SHRINK_ANIMATE_ON_PRESS_META_DATA =
            new CssMetaData<>(ButtonAnimationHelper.SHRINK_ANIMATE_ON_PRESS_PROPERTY_NAME,
                ...
                public boolean isSettable(ToggleButton button) {
                    final ShrinkToggleButtonSkin skin = (ShrinkToggleButtonSkin) button.getSkin();
