...
public class SliderSkin extends javafx.scene.control.skin.SliderSkin {
    ...
    private static double TRACK_TO_TIK_GAP = 2;
    ...
    protected void layoutChildren(double x, double y, double w, double h) {
        ...
        if (getSkinnable().getOrientation() == Orientation.HORIZONTAL) {
            ...
            double totalHeightNeeded = trackAreaHeight  + ((showTickMarks) ? TRACK_TO_TIK_GAP +tickLineHeight : 0);
            ...
            double totalWidthNeeded = trackAreaWidth  + ((showTickMarks) ? TRACK_TO_TIK_GAP +tickLineWidth : 0) ;
